...
import { Mail, Lock, Calculator, ArrowLeft } from 'lucide-react';
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (user.role === 'ACCOUNTANT') {
        ...
        toast.error('You are not authorized as an Accountant');
      ...
      <div className="hidden lg:flex flex-col justify-between w-[40%] shrink-0 border-r border-[#0f172a] bg-[#070c1a] px-12 py-12 relative z-10">
        ...
        <div>
          <div className="inline-flex items-center gap-2 bg-[#0f1b35] border border-[#1e3a5f] rounded-full px-3 py-1.5 mb-8">
            ...
            <span className="text-[#2563eb] text-[11px] font-medium tracking-wide">Accountant Portal</span>
          </div>
          <h2 className="text-2xl font-bold text-white leading-tight mb-4 tracking-tight">
            Invoice Management Suite
          </h2>
          <p className="text-[#334155] text-sm leading-relaxed">
            Create and manage invoices, track clients, and generate detailed financial reports with ease.
          </p>

          
        </div>

        <p className="text-[#1e293b] text-xs">© 2026 InvoiceFlow. All rights reserved.</p>
      </div>

      <div className="flex-1 flex items-center justify-center px-6 sm:px-12 py-12 relative z-10">
        <div className="w-full max-w-md">
          <div className="mb-10">
            <p className="text-[#2563eb] text-xs font-semibold tracking-widest uppercase mb-3">Accountant Login</p>
            <h1 className="text-2xl font-bold text-white tracking-tight mb-2">Sign in to your account</h1>
            <p className="text-[#475569] text-sm">Enter your credentials to access the accountant console</p>
          </div>
